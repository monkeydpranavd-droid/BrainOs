    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="h-7 w-7 rounded-lg bg-indigo-650 flex items-center justify-center text-white shrink-0 shadow-md shadow-indigo-650/10">
          ...
          <div className="truncate">
            ...
            <p className="text-sm font-semibold text-slate-200 truncate leading-none">
              {loading ? "Loading..." : activeOrg ? activeOrg.name : "Select Org"}
            </p>
          </div>
        </div>
