...
export default function Page() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-zinc-950 text-zinc-100 min-h-screen">
      {/* Navigation Sidebar */}
      <Sidebar
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="flex-1 p-8 flex flex-col justify-start">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs text-zinc-500 mt-0.5">
                  Explore semantic linkages and relationship structures between
          ...
          {currentTab === "integrations" && <IntegrationsControl />}
